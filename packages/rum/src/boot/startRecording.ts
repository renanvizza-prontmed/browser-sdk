import type { RawError, HttpRequest, DeflateEncoder } from '@renanvizza-prontmed/browser-core'
import { timeStampNow, createHttpRequest, addTelemetryDebug } from '@renanvizza-prontmed/browser-core'
import type {
  LifeCycle,
  ViewContexts,
  RumConfiguration,
