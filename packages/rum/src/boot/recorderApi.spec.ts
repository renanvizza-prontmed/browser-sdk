import type { DeflateWorker } from '@renanvizza-prontmed/browser-core'
import { display, isIE } from '@renanvizza-prontmed/browser-core'
import type { RecorderApi, ViewContexts, LifeCycle, RumConfiguration } from '@renanvizza-prontmed/browser-rum-core'
import { LifeCycleEventType } from '@renanvizza-prontmed/browser-rum-core'
import { deleteEventBridgeStub, initEventBridgeStub, createNewEvent } from '@renanvizza-prontmed/browser-core/test'
