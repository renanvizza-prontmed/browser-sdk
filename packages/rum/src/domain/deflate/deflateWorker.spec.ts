import type { RawTelemetryEvent } from '@renanvizza-prontmed/browser-core'
import { display, isIE, resetTelemetry, startFakeTelemetry } from '@renanvizza-prontmed/browser-core'
