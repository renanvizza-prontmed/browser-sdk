...
import { timeStampNow } from '@renanvizza-prontmed/browser-core'
import type { LifeCycle, RumConfiguration } from '@renanvizza-prontmed/browser-rum-core'
import { getViewportDimension, getScrollX, getScrollY } from '@renanvizza-prontmed/browser-rum-core'
import type {
  BrowserMutationData,
