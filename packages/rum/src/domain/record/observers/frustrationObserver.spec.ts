import { isIE, relativeNow, timeStampNow } from '@openobserve/browser-core'
import type { RawRumActionEvent } from '@openobserve/browser-rum-core'
import { ActionType, LifeCycle, LifeCycleEventType, RumEventType, FrustrationType } from '@openobserve/browser-rum-core'
