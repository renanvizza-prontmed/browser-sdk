import { isIE, relativeNow, timeStampNow } from '@renanvizza-prontmed/browser-core'
import type { RawRumActionEvent } from '@renanvizza-prontmed/browser-rum-core'
import { ActionType, LifeCycle, LifeCycleEventType, RumEventType, FrustrationType } from '@renanvizza-prontmed/browser-rum-core'
