import type { DefaultPrivacyLevel, ListenerHandler } from '@renanvizza-prontmed/browser-core'
import { DOM_EVENT, throttle, addEventListener } from '@renanvizza-prontmed/browser-core'
import type { RumConfiguration } from '@renanvizza-prontmed/browser-rum-core'
import { getScrollX, getScrollY } from '@renanvizza-prontmed/browser-rum-core'
