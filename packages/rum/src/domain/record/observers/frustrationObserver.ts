...
import type { LifeCycle } from '@renanvizza-prontmed/browser-rum-core'
import { ActionType, RumEventType, LifeCycleEventType } from '@renanvizza-prontmed/browser-rum-core'
