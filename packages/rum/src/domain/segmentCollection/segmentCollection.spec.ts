import type { ClocksState, HttpRequest, TimeStamp } from '@renanvizza-prontmed/browser-core'
import { DeflateEncoderStreamId, PageExitReason, isIE } from '@renanvizza-prontmed/browser-core'
import type { ViewContexts, ViewContext, RumConfiguration } from '@renanvizza-prontmed/browser-rum-core'
import { LifeCycle, LifeCycleEventType } from '@renanvizza-prontmed/browser-rum-core'
import type { Clock } from '@renanvizza-prontmed/browser-core/test'
import { mockClock, restorePageVisibility } from '@renanvizza-prontmed/browser-core/test'
