import type { DeflateEncoder, HttpRequest, TimeoutId } from '@renanvizza-prontmed/browser-core'
import { isPageExitReason, ONE_SECOND, clearTimeout, setTimeout } from '@renanvizza-prontmed/browser-core'
import type { LifeCycle, ViewContexts, RumSessionManager, RumConfiguration } from '@renanvizza-prontmed/browser-rum-core'
