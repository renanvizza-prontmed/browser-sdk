import type { DeflateEncoder, TimeStamp } from '@renanvizza-prontmed/browser-core'
import { noop, setDebugMode, isIE, DeflateEncoderStreamId } from '@renanvizza-prontmed/browser-core'
