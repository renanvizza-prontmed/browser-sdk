import type { Context, ContextManager, TimeStamp } from '@renanvizza-prontmed/browser-core'
import { CustomerDataType, assign, combine, createContextManager, noop, Observable } from '@renanvizza-prontmed/browser-core'
import type { Clock } from '@renanvizza-prontmed/browser-core/test'
import { mockClock, buildLocation, SPEC_ENDPOINTS } from '@renanvizza-prontmed/browser-core/test'
