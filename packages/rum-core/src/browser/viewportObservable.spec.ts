import type { Subscription } from '@renanvizza-prontmed/browser-core/src/tools/observable'
import type { Clock } from '@renanvizza-prontmed/browser-core/test'
import { mockClock, createNewEvent } from '@renanvizza-prontmed/browser-core/test'
