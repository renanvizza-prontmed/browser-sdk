import type { Duration, RelativeTime, Subscription, TimeStamp } from '@renanvizza-prontmed/browser-core'
import { DOM_EVENT, Observable, isIE } from '@renanvizza-prontmed/browser-core'
