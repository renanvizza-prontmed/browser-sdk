import type { Context, ContextManager, FlushEvent, Observable, Telemetry } from '@renanvizza-prontmed/browser-core'
import { isEmptyObject, includes, performDraw, ONE_SECOND, addTelemetryDebug, setInterval } from '@renanvizza-prontmed/browser-core'
