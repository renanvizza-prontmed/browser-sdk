import type { RelativeTime, Subscription } from '@renanvizza-prontmed/browser-core'
import { Observable, ONE_SECOND, getTimeStamp } from '@renanvizza-prontmed/browser-core'
