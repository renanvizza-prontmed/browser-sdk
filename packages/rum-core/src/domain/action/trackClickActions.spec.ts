import type { Context, Duration } from '@renanvizza-prontmed/browser-core'
import { addDuration, clocksNow, timeStampNow, relativeNow } from '@renanvizza-prontmed/browser-core'
