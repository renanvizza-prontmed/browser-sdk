...
import { isIE, RequestType } from '@renanvizza-prontmed/browser-core'
import type { FetchStub, FetchStubManager } from '@renanvizza-prontmed/browser-core/test'
import { SPEC_ENDPOINTS, stubFetch, stubXhr, withXhr } from '@renanvizza-prontmed/browser-core/test'
