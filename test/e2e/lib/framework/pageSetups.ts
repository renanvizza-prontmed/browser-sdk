...
// Adds __ooIsTrusted: true to all events generated by e2e tests so we can track untrusted events generated by wdio
export function setupTrustedEvents() {
  return html` <script type="text/javascript">
    ${JSON.stringify(Object.values(DOM_EVENT))}.forEach(function (eventName) {
