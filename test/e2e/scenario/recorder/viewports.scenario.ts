import type { ViewportResizeData, ScrollData } from '@renanvizza-prontmed/browser-rum/cjs/types'
import { IncrementalSource } from '@renanvizza-prontmed/browser-rum/cjs/types'

import { findAllIncrementalSnapshots, findAllVisualViewports } from '@renanvizza-prontmed/browser-rum/test'
